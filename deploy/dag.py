...
with DAG('eval_adversarial_example_acc_test_tf2.3_0.1', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    ...
    t2 = DockerOperatorEx(
        ...
        image='qunomon/eval_adversarial_example_acc_test_tf2.3:0.1',
